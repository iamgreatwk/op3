...
**此假设已被 OP3-BOOT-028 证伪。** mainline v6.4 + 严格 v74 完整配置 +
移植的 S6E3FA5 面板驱动**能启动**，证明根因是**配置完整度 + 面板驱动**，
而非 `.idmap.text` 或任何内核早期代码。见
`docs/handoff/root-cause-config-completeness.md`。
