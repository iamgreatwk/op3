...
case "$source_commit" in
  "$TARGET_KERNEL_COMMIT"|91df7ccd284e5c62c5aed13c2738192b96c1f8dd|955ea0e962134ad27b0fd6fc9b6945c6ffce4817|401a5673192be4239aecfddb5594f254d3d3e2a2)
    ;;
  *)
    printf 'Refusing unexpected kernel source commit: %s\n' "$source_commit" >&2
    printf 'Expected baseline %s, own-DTB 91df7ccd, or audio-DTS 955ea0e/401a567.\n' \
